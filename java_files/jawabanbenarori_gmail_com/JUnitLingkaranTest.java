package jawabanbenarori_gmail_com;
...
public class JUnitLingkaranTest {
	  ...
	  public void isLingkaran() {
		double dataLuas = jawabanbenarori_gmail_com.Lingkaran.luasLingkaran(3.14, 14);
		double expectedOutputLuas = 615.44;
	    assertEquals("calculate luas not the same",expectedOutputLuas,Double.valueOf(dataLuas), 0.01);
	    
	    double dataKeliling = jawabanbenarori_gmail_com.Lingkaran.kelilingLingkaran(3.14, 14);
	    ...
	    jawabanbenarori_gmail_com.Lingkaran.main(null);
