...
public class JUnitBankTest {
	  ...
	  public void isLingkaran() {
		double dataBunga = kunci4lowertandanonsistematissteeming_gmail_com.Bank.hitungBunga(1000000, 6, 5);
	    ...
	    kunci4lowertandanonsistematissteeming_gmail_com.Bank.main(null);
